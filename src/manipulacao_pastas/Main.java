...
public class Main {
	...
	public static void main(String[] args) {
		...
		try {
			...
			input.nextLine();
			String targetFile = pathString + "\\" + input.nextLine() + ".csv"; // criando um arquivo .csv na pasta de destino.
			
			try(BufferedWriter bWriter = new BufferedWriter(new FileWriter(targetFile))){
